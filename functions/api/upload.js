...
export async function onRequestPost(context) {
    ...
    try {
        ...
        const extension = 'webp'; // We'll store as webp

        // For now, store the original format since we can't process on edge
        // In production, you might want to use Cloudflare Images for transformation
        ...
        // Upload to R2
        // For thumbnails, we'd ideally resize, but edge functions have limited compute
        // Using Cloudflare Images or a separate processing worker would be better
